...
for rri in rri_list:
    ...
    print(raw_rri)
    cleaned_rri = preprocessing.remove_outliers(raw_rri) 
    fill_nan_rri = preprocessing.interpolate_nan_values(cleaned_rri)
    preprocessed_rri_list.append(fill_nan_rri)


print('preprocessed_rri_list',preprocessed_rri_list)
